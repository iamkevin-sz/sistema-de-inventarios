<tr>
    <th scope="row">
        <a href="{{route('admin.sales.show', $sale)}}">{{$sale->id}}</a>
    </th>
    <td>
    ...
    <td>{{$sale->status}}</td>
    <td style="width: 20%;">
        <a href="{{route('admin.sales.pdf', $sale)}}" class="btn btn-outline-danger"
        ...
        title="Imprimir boleta"><i class="fas fa-print"></i></a>
        <a href="{{route('admin.sales.show', $sale)}}" class="btn btn-outline-info"
